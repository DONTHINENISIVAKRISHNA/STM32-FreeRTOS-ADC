...
int main(void)
{
  ...
  HAL_Delay(100);
  printf("\r\n==============================================\r\n");
  printf("  STM32 FreeRTOS Workshop - Module 7B        \r\n");
  printf("  ADC with FreeRTOS Task                     \r\n");
  printf("==============================================\r\n\r\n");
  ...
  /* definition and creation of AlertTask */
  osThreadDef(AlertTask, StartAlertTask, osPriorityNormal, 0, 128);
  AlertTaskHandle = osThreadCreate(osThread(AlertTask), NULL);
